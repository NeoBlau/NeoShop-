...
const CLIP_LABELS: Record<string, { ru: string; en: string }> = {
  ...
  return_to_dock: { ru: 'Вернуться на базу', en: 'Return to the dock' },
  brushes_spin: { ru: 'Раскрутить щётки', en: 'Spin the brushes' },
  lidar_scan: { ru: 'Просканировать комнату', en: 'Scan the room' },
